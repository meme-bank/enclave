...
export function ValidateEnvironmentConfiguration() {
  ...
  const vk = {
    client_id: validateAndParseInt(
      'VK_CLIENT_ID',
      process.env.VK_CLIENT_ID || '51716242',
      10,
    ),
...
export type EnvironmentConfiguration = ReturnType<
  typeof ValidateEnvironmentConfiguration
>;
